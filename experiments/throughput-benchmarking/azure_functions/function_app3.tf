...
data "archive_file" "throughput-benchmarking3-function-code" {
  type = "zip"
  source_dir = "function_code/throughput-benchmarking3"
...
resource "azurerm_function_app" "throughput-benchmarking3" {
  ...
  name = "throughput-benchmarking3-python"
