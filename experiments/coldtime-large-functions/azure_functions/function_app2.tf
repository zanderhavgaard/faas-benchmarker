...
data "archive_file" "coldtime-large-functions2-function-code" {
  type = "zip"
  source_dir = "function_code/coldtime-large-functions2"
...
resource "azurerm_function_app" "coldtime-large-functions2" {
  ...
  name = "coldtime-large-functions2-python"
