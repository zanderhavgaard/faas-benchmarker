...
data "archive_file" "weakest-link1-function-code" {
  type = "zip"
  source_dir = "function_code/weakest-link-function1"
...
resource "azurerm_template_deployment" "weakest-link1-function-key" {
...
output "weakest-link-function1_function_key" {
  value = "${lookup(azurerm_template_deployment.weakest-link1-function-key.outputs, "functionkey")}"
}
output "weakest-link-function1_function_app_url" {
