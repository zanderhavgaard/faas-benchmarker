...
data "archive_file" "track-cloudfunctions-lifecycle2-function-code" {
  type = "zip"
  source_dir = "function_code/track-cloudfunctions-lifecycle-function2"
...
resource "azurerm_function_app" "track-cloudfunctions-lifecycle2" {
  ...
  name = "track-cloudfunctions-lifecycle-function2"
...
output "track-cloudfunctions-lifecycle-function2_function_key" {
  value = "${lookup(azurerm_template_deployment.track-cloudfunctions-lifecycle2-function-key.outputs, "functionkey")}"
}
output "track-cloudfunctions-lifecycle-function2_function_app_url" {
