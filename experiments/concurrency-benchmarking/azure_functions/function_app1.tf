...
data "archive_file" "concurrency-benchmarking1-function-code" {
  type = "zip"
  source_dir = "function_code/concurrency-benchmarking1"
...
resource "azurerm_function_app" "concurrency-benchmarking1" {
  ...
  name = "concurrency-benchmarking1-python"
