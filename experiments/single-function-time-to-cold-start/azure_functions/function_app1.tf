...
data "archive_file" "single-function-time-to-cold-start1-function-code" {
  type = "zip"
  source_dir = "function_code/single-function-time-to-cold-start1"
...
resource "azurerm_function_app" "single-function-time-to-cold-start1" {
  ...
  name = "single-function-time-to-cold-start1-python"
...
resource "azurerm_template_deployment" "single-function-time-to-cold-start1-function-key" {
  depends_on = [azurerm_function_app.single-function-time-to-cold-start1]

  name = "single-function-time-to-cold-start1_get_function_key"
  parameters = {
    "functionApp" = azurerm_function_app.single-function-time-to-cold-start1.name
  }
  resource_group_name    = azurerm_resource_group.single-function-time-to-cold-start-rg.name
...
output "single-function-time-to-cold-start1_function_key" {
  value = "${lookup(azurerm_template_deployment.single-function-time-to-cold-start1-function-key.outputs, "functionkey")}"
}
output "single-function-time-to-cold-start1_function_app_url" {
  value = azurerm_function_app.single-function-time-to-cold-start1.default_hostname
}
