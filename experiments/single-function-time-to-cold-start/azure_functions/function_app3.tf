...
data "archive_file" "single-function-time-to-cold-start3-function-code" {
  type = "zip"
  source_dir = "function_code/single-function-time-to-cold-start-function3"
...
resource "azurerm_function_app" "single-function-time-to-cold-start3" {
  ...
  name = "single-function-time-to-cold-start-function3"
...
output "single-function-time-to-cold-start-function3_function_key" {
  value = "${lookup(azurerm_template_deployment.single-function-time-to-cold-start3-function-key.outputs, "functionkey")}"
}
output "single-function-time-to-cold-start-function3_function_app_url" {
