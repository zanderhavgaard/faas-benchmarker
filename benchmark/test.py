...
# lib.baseline(run_time=30,sleep_time=2,functions=[lambda x: print(x)], args=[('invoking baseline')])
...
try:
    ...
    lib.baseline(run_time=30,sleep_time=2,functions=[lambda x: validate(invoke,x)], args=[('invoking baseline')])
