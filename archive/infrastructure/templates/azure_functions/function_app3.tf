...
data "archive_file" "changeme3-function-code" {
  type = "zip"
  source_dir = "function_code/changeme-function3"
...
resource "azurerm_template_deployment" "changeme3-function-key" {
...
output "changeme-function3_function_key" {
  value = "${lookup(azurerm_template_deployment.changeme3-function-key.outputs, "functionkey")}"
}
output "changeme-function3_function_app_url" {
